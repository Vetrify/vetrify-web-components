...
export class Alert {
  ...
  @Element() host: HTMLVAlertElement;
    ...
    return new Promise<void>(resolve => {
      ...
      this.host.addEventListener(
        ...
        () => {
          ...
          if (toastStack.querySelector('v-alert') === null) {
            toastStack.remove();
          }
        },
        { once: true }
      ...
      >
        ...
        {this.closable && (
          <span class="alert__close">
            <v-icon-button exportparts="base:close-button" name="x" onClick={this.handleCloseClick} />
          </span>
        )}
      </div>
    );
