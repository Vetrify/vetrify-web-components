...
export class ColorPicker {
  ...
  input: HTMLVInputElement;
  lastValueEmitted: string;
  menu: HTMLElement;
  previewButton: HTMLButtonElement;
  trigger: HTMLButtonElement;

  @Element() host: HTMLVColorPickerElement;
  ...
  handleDocumentMouseDown(event: MouseEvent) {
    ...
    if (target.closest('v-color-picker') !== this.host) {
      this.dropdown.hide();
    }
  }
        ...
        >
          ...
          <div class="color-picker__user-input">
            <v-input
              ...
              onv-change={this.handleInputChange}
            />

            {!this.noFormatToggle && (
              <v-button exportparts="base:format-button" size="small" onClick={this.handleFormatToggle}>
