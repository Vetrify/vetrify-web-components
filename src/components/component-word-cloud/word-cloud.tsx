...
// TODO: get this working with new adding (see adr) & cleanup from amcharts4 removal
...
export class Card {
  @Element() host: HTMLVWordCloudElement;
  ...
  componentDidRender() {
    // let chart = create("chartdiv", WordCloud);
  ...
  render(words) {
    return (
      <div class="word-cloud" id="chartdiv" >
