...
export class Menu {
  ...
  @Element() host: HTMLVMenuElement;

  /** Emitted when a menu item is selected. */
  @Event({ eventName: 'v-select' }) slSelect: EventEmitter<{ item: HTMLVMenuItemElement }>;
  ...
  setActiveItem(item: HTMLVMenuItemElement) {
    item.setFocus();
  }

  handleClick(event: MouseEvent) {
    const target = event.target as HTMLElement;
    const item = target.closest('v-menu-item');
