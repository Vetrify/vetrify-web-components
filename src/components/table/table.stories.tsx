...
export   const HeaderSlotTemplate = (
...
<div class="d-flex flex-column-fluid">
         ...
         bordered="false">
          ...
          <div slot="header" class="card-header-slot" >
            <div class="card-title">
              <h3 class="card-label" style="margin:0; ">
                Trending Items
              </h3>
            </div>
            <p class="card-label" style="margin: 0; color:#b5b5c3; font-weight: 300">
          ...
          <div style="display:flex; justify-content:space-between;align-items:center; width:100%">
            <div style="display:flex;justify-content:space-between;align-items:center">
              <v-avatar shape="square">
              <v-icon slot="icon" name="image"></v-icon>
              </v-avatar>
              <v-persona-brief name="Active Customer" heading="Best customers" />
            </div>
  ...
  // TODO: make this version work with components replacing items
  export const BaseTableWithComponents = () => `
  <div style="width:500px">
    <v-widget heading="Files" subheading="More than 400 + members">
    </v-widget>
  </div>
  `
export const BaseTableHtml = () => `
