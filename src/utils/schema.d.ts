declare namespace VSchemaInternal {
    type SchemaBase = {
        $id?: string
        $ref?: string
        type?: string
   ...
   type VSchemaTupleSchema<Tuple> = 
    ...
    type VSchemaTupleSchemaWithAdditional<Tuple, Additional> =
    ...
    type ResolveRecursive<SchemaType> =
        SchemaType extends TupleSchema<infer TupleType, infer Additional> ? (Additional extends null ? VSchemaTupleSchema<TupleType> : VSchemaTupleSchemaWithAdditional<TupleType, Additional>) :
...
export type VSchema<Schema> = VSchemaInternal.ResolveRootSchema<Schema>